...
export default function Page() {
  return (
    <div className="flex flex-col items-center text-center py-10 px-4">
      ...
      <p className="mt-6 max-w-120">Restaria Liba biedt niet alleen een uitgebreid assortiment aan heerlijke gerechten voor gasten die graag ter plaatse willen genieten, maar ook een handige afhaalservice voor degenen die liever thuis van onze smaken genieten. Bestel eenvoudig online of telefonisch, en haal je favoriete gerechten op wanneer het jou uitkomt. We kijken ernaar uit om je te verwelkomen in ons restaurant of je bestelling gereed te maken voor afhalen!</p>
