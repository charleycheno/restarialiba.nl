...
export default async function Page() {
  return (
    <div className="flex flex-col items-center text-center py-10 px-4">
      ...
      <p className="mt-6 max-w-120">Welkom bij Restaria Liba! Ontdek de smaakvolle wereld van heerlijke gerechten die wij te bieden hebben. Van sappige hamburgers tot knapperige frietjes, bij ons vind je alles voor een smakelijke maaltijd. Bekijk ons menu en plaats vandaag nog je bestelling!</p>
